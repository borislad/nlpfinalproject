    ...
    while True:
        ...
        if selected_word.lower() == spoken_word.lower():
            ...
            for syllable in syllables:
                ...
                recorded_syllable_file_path = "/Users/borisl/HIT/nlpfinalproject/word_verification/syllable_recordings/" + syllable + ".wav"
                record_audio(2, syllable, recorded_syllable_file_path)
                syllables_audio_file_path = "/Users/borisl/HIT/nlpfinalproject/word_verification/syllables_audio/" + syllable + ".wav"
